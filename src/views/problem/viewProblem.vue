<template>
  <div class="view-problem">
    ...
    <div class="vote-body">
      ...
      <el-button @click="likeProblem" type="danger" class="iconfont icon-good">喜欢此文({{ problem.likeNum }})</el-button>
      <el-button type="success" class="el-icon-hot-water">给作者倒杯卡布奇诺</el-button>
    </div>
